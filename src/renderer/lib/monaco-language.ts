...
export const SQL_STUDIO_THEME: SqlStudioThemeData = {
  ...
  colors: {
    // 阶段 1：编辑器底色对齐画布（--color-bg），关键字/光标对齐品牌靛紫
    ...
    'editor.selectionBackground': '#3A3F7A',
    'editor.inactiveSelectionBackground': '#232744',
    ...
    'editorWidget.background': '#1B1D20',
...
export const SQL_STUDIO_THEME_LIGHT: SqlStudioThemeData = {
  ...
  inherit: true,
  rules: [
    { token: 'keyword', foreground: '5B62D4', fontStyle: 'bold' },
...
export const SQL_STUDIO_THEME_TITANIUM: SqlStudioThemeData = {
  ...
  inherit: true,
  rules: [
    { token: 'keyword', foreground: '565FB8', fontStyle: 'bold' },
  ...
  colors: {
    ...
    'editor.lineHighlightBackground': '#E8EDF2',
    'editorWidget.background': '#FFFFFF',
    'editorSuggestWidget.background': '#FFFFFF',
